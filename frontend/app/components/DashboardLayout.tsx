          ...
          <div className="p-6 relative">
            <div className="mb-8">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-[#00d084] shadow-[0_4px_6px_-1px_rgba(4,129,129,0.1)]">
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center gap-4 px-5 py-4 rounded-[0.875rem] font-semibold transition-all duration-300 text-sm ${
                      active ? 'bg-[#00d084] text-white shadow-md' : 'text-[#00d084] hover:bg-[#F9FAFB]'
                    }`}
                  >
