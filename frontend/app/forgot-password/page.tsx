            ...
            <div className="bg-[#1E293B]/90 backdrop-blur-xl border border-[#334155] rounded-3xl p-8 md:p-10 shadow-2xl">
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <Link
                    href="/login"
                    className="block w-full bg-[#048181] hover:bg-[#048181] text-white py-4 rounded-xl font-black transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-[#048181]/50"
                  >
                    Back to Login
                  </Link>
                  <button
                    onClick={() => setSent(false)}
                    className="block w-full border-2 border-[#334155] bg-[#0F172A]/50 text-white py-4 rounded-xl font-bold hover:border-[#048181] transition-all"
                  >
                    Send Another Email
                  </button>
                </div>
